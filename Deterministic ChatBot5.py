...
while True:
	...
	print('7 - add collaborators')
	print('8 - remove collaborators')
	print('9 - exit')
	i = int(input())
	if i == 1:
		...
		invite(repo_name, user_name)
	elif i == 8:
		repo_name = input('enter name of the repository')
		user_name = input('enter user name')
		excommunicado(repo_name, user_name)
	elif i == 9:
		break
	else:
		print('wrong choice')
